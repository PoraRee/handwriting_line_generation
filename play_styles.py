...
print(
    'inter dist mean: {}, stddev: {}'.format(
        np.mean(inter_author_dist),
        np.std(inter_author_dist)))
print(
    'intra dist mean: {}, stddev: {}'.format(
        np.mean(intra_author_dist),
        np.std(intra_author_dist)))
