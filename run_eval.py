...
# python new_eval.py -c
# saved/allfontSmall_ocr_softmax_1huge/checkpoint-iteration650000.pth -g 0
# -f cf_test_on_FUNSD.json

# saved/IAMslant_noMask_bigStyleEx_GANMedMT_autoAEMoPrcp2tightNoPyr_balB_hCF0.75_sMG

# python get_styles.py -c
# saved/IAMslant_noMask_charSpecSingleAppend_GANMedMT_autoAEMoPrcp2tightNewCTCUseGen_balB_hCF0.75_sMG/checkpoint-iteration175000.pth
# -g 0 -d direiogtjaerjkl -T
...
# python interpolate.py -c
# saved/IAMslant_noMask_charSpecSingleAppend_GANMedMT_autoAEMoPrcp2tightNewCTCUseGen_balB_hCF0.75_sMG/checkpoint-iteration175000.pth
# -g 0 -d final2_mturk -a
# style_loc=saved/IAMslant_noMask_charSpecSingleAppend_GANMedMT_autoAEMoPrcp2tightNewCTCUseGen_balB_hCF0.75_sMG/test_styles_175000.pkl
# -r choice=t,num_inst=35 -T
...
# python new_eval.py -c
# saved/IAMslant_noMaskNoSpace_bigStyleExAppend_GANMedMT_noAuto_balB_hCF0.75_sMG/checkpoint-latest.pth
# -n 8 -e [gen] -d out -a data_loader=short=1 -g 0 -v 1
...
# python new_eval.py -c
# saved/IAMslant_noMask_bigStyleExAppend_noGAN_autoAEMoPrcp2tightNewCTC_balB_hCF0.75_sMG/checkpoint-latest.pth
# -n 8 -e [recon_pred_space,gen] -d out -a data_loader=short=1 -g 0 -v 1
